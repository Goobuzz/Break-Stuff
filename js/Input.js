	...
	function touchStart(e){
		...
		//for(var i = 0, ilen = e.changedTouches.length; i < ilen; i++){
            ...
            var id = touch.identifier;
           	//Input.touchPosition.x = touch.pageX;
            //Input.touchPosition.y = touch.pageY;
            Game.raiseEvent("TouchStart", touch.pageX, touch.pageY);
      //  }
	};
	function touchEnd(e){
